...
public:
    ...
    virtual std::vector<std::pair<int, int>> getLegalMoves(int startX, int startY, const Board& board) const = 0;
...
public:
    ...
    std::vector<std::pair<int, int>> getLegalMoves(int startX, int startY, const Board& board) const override;
